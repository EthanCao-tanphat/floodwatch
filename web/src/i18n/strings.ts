...
export const vi = {
  ...
  recLow: 'Tuyến đường an toàn trong 60–90 phút tới.',

  // ---- Photo report ----
  photoTitle: 'Báo cáo ngập',
  photoSubtitle: 'Chụp ảnh đường ngập, AI sẽ phân loại độ sâu',
...
export const en: Strings = {
  ...
  recLow: 'Route looks safe in the next 60–90 minutes.',

  photoTitle: 'Report flooding',
  photoSubtitle: 'Snap a photo of flooded road, AI classifies the depth',
